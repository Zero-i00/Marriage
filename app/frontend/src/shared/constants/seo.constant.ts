import { APP_HOST } from "@/shared/constants/app.constant";

export const SITE_NAME = "Свадьба Артёма и Вари";

export const SEO_URL = APP_HOST;
...
export const HALL_ADDRESS =
  "Свердловская обл., пос. Хрустальная, ул. Трактовая, 31";
