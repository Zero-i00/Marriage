...
def drink_menu_keyboard(items: list[SchemaDrinkResponse]) -> InlineKeyboardMarkup:
...
def drink_delete_keyboard(items: list[SchemaDrinkResponse]) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    for item in items:
